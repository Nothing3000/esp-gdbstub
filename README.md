...
Usage
-----
 * Add `  - origin: https://github.com/Nothing3000/esp-gdbstub` to your mos.yml file.
 * Configure gdbstub by adding options from gdbstub-cfg.h to build_vars in mos.yml.
options you can tweak: FreeRTOS or bare SDK, private exception/breakpoint stack, console redirection to GDB, wait till debugger attachment etc.
